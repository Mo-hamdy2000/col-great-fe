const unit_two = (
  <>
    <div className="text-center">
        <a href="https://forms.office.com/r/7gBCXvcMaY" style={{
          ...
          الاختبار القبلي للموديول الثاني
        </a>
      </div>
      <div className="text-center">
        <a href="https://forms.office.com/r/NSJ5QY9M8e" style={{
          display: 'inline-block',
          padding: '2rem 1rem',
          margin: '0.5rem',
          fontSize: '1.125rem',
          ...
          الاختبار البعدي للموديول الثاني
        </a>
      </div>
  </>
)
